// Generated by @wagmi/cli@1.0.0 on 14/06/2024 at 13:44:54
import {
  useContractRead,
...
/**
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export const votingABI = [
  {
    ...
    inputs: [
      ...
      { name: 'positive', internalType: 'bool', type: 'bool', indexed: false }
    ],
    name: 'Vote'
  },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [{ name: 'documentId', internalType: 'uint256', type: 'uint256' }],
    name: 'getDownVotes',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }]
  },
  {
...
export const votingAddress = {
  137: '0x7c648E2C5f96FfD7852ec38731A74b972D79949E'
} as const

/**
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export const votingConfig = { address: votingAddress, abi: votingABI } as const
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link votingABI}__.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof votingABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof votingABI, TFunctionName, TSelectData>,
    'abi' | 'address'
  > & { chainId?: keyof typeof votingAddress } = {} as any
) {
  return useContractRead({
    abi: votingABI,
    address: votingAddress[137],
    ...config
  } as UseContractReadConfig<typeof votingABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link votingABI}__ and `functionName` set to `"getDownVotes"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingGetDownVotes<
  TFunctionName extends 'getDownVotes',
  TSelectData = ReadContractResult<typeof votingABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof votingABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link votingABI}__ and `functionName` set to `"getUpVotes"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingGetUpVotes<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link votingABI}__.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingWrite<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof votingAddress
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof votingABI, string>['request']['abi'],
        TFunctionName,
        TMode
      > & { address?: Address; chainId?: TChainId }
    : UseContractWriteConfig<typeof votingABI, TFunctionName, TMode> & {
        abi?: never
        address?: never
        chainId?: TChainId
      } = {} as any
) {
  return useContractWrite<typeof votingABI, TFunctionName, TMode>({
    abi: votingABI,
    address: votingAddress[137],
    ...config
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link votingABI}__ and `functionName` set to `"vote"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingVote<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof votingAddress
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof votingABI, 'vote'>['request']['abi'],
        'vote',
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: 'vote' }
    : UseContractWriteConfig<typeof votingABI, 'vote', TMode> & {
        abi?: never
        address?: never
        chainId?: TChainId
        functionName?: 'vote'
  ...
  return useContractWrite<typeof votingABI, 'vote', TMode>({
    abi: votingABI,
    address: votingAddress[137],
    functionName: 'vote',
    ...config
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link votingABI}__.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function usePrepareVotingWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof votingABI, TFunctionName>,
    'abi' | 'address'
  > & { chainId?: keyof typeof votingAddress } = {} as any
) {
  return usePrepareContractWrite({
    ...
    address: votingAddress[137],
    ...config
  } as UsePrepareContractWriteConfig<typeof votingABI, TFunctionName>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link votingABI}__ and `functionName` set to `"vote"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function usePrepareVotingVote(
  config: Omit<
    UsePrepareContractWriteConfig<typeof votingABI, 'vote'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof votingAddress } = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: 'vote',
    ...config
  } as UsePrepareContractWriteConfig<typeof votingABI, 'vote'>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link votingABI}__.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingEvent<TEventName extends string>(
  config: Omit<
    UseContractEventConfig<typeof votingABI, TEventName>,
    'abi' | 'address'
  > & { chainId?: keyof typeof votingAddress } = {} as any
) {
  return useContractEvent({
    ...
    address: votingAddress[137],
    ...config
  } as UseContractEventConfig<typeof votingABI, TEventName>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link votingABI}__ and `eventName` set to `"Vote"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x7c648E2C5f96FfD7852ec38731A74b972D79949E)
 */
export function useVotingVoteEvent(
  config: Omit<
    UseContractEventConfig<typeof votingABI, 'Vote'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof votingAddress } = {} as any
) {
  return useContractEvent({
    ...
    eventName: 'Vote',
    ...config
  } as UseContractEventConfig<typeof votingABI, 'Vote'>)
}
