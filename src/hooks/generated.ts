// Generated by @wagmi/cli@1.0.0 on 09/02/2024 at 17:11:09
import {
  useContractRead,
...
/**
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x627B8256ecAaA65162b9C97AeAc4E8B4094E0f87)
 */
export const altBaseABI = [
  ...
  },
  {
    ...
    name: 'collectionRequiresPermissions',
    outputs: [{ name: '', internalType: 'bool', type: 'bool' }]
  },
  {
    stateMutability: 'view',
...
export const altBaseAddress = {
  137: '0x627B8256ecAaA65162b9C97AeAc4E8B4094E0f87'
} as const
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link altBaseABI}__ and `functionName` set to `"collectionRequiresPermissions"`.
 *
 * [__View Contract on Polygon Polygon Scan__](https://polygonscan.com/address/0x627B8256ecAaA65162b9C97AeAc4E8B4094E0f87)
 */
export function useAltBaseCollectionRequiresPermissions<
  TFunctionName extends 'collectionRequiresPermissions',
  TSelectData = ReadContractResult<typeof altBaseABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof altBaseABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    abi: altBaseABI,
    address: altBaseAddress[137],
    functionName: 'collectionRequiresPermissions',
    ...config
  } as UseContractReadConfig<typeof altBaseABI, TFunctionName, TSelectData>)
}
